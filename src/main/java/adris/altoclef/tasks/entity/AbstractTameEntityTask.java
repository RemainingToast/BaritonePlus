...
public abstract class AbstractTameEntityTask<E extends Entity> extends AbstractDoToEntityTask {
    ...
    protected abstract boolean canTame(AltoClef mod, E entity);

    protected abstract Task onTameInteract(AltoClef mod, E entity);

    protected abstract boolean isTamed(AltoClef mod, E entity);

    protected abstract Task onTameFinish(AltoClef mod, E entity);
