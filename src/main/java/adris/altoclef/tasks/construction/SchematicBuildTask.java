...
//        this.schematicFile = file;
    ...
    protected Task onTick(AltoClef mod) {
        ...
        if (!isNull(getMissing()) && !getMissing().isEmpty() && (builder.isPaused() || !builder.isFromAltoclef() || !builder.isActive())) {
            ...
            if (StorageHelper.calculateInventoryFoodScore(mod) < MIN_FOOD_UNITS || _shouldForce(mod, _foodTask)) {
...
//                    || _shouldForce(mod, _resourceTask)
//            )) {
...
//            }
    ...
    protected static class SchematicBaritoneSettings {
        @NonNull private final AltoClef mod;

        protected SchematicBaritoneSettings(@NonNull AltoClef mod) {
            this.mod = mod;
        }
