...
public class SCP173Task extends Task {
    ...
    private boolean isSeenByPlayer(BaritonePlus mod) {
    ...
    private boolean entityIsLookingInOurGeneralDirection(BaritonePlus mod, PlayerEntity other) {
    ...
    private boolean entityHasLineOfSightToUs(BaritonePlus mod, PlayerEntity other) {
