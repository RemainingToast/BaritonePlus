...
public class CollectFoodTask extends Task {
     ...
     */
    private Task pickupBlockTaskOrNull(BaritonePlus mod, Block blockToCheck, Item itemToGrab, Predicate<BlockPos> accept, double maxRange) {
    ...
    private Task pickupBlockTaskOrNull(BaritonePlus mod, Block blockToCheck, Item itemToGrab, double maxRange) {
