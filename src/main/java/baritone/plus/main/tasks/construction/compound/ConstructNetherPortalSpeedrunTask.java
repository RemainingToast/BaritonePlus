...
import baritone.plus.main.tasks.construction.ClearLiquidTask;
 ...
 */
public class ConstructNetherPortalSpeedrunTask extends baritone.plus.api.tasks.Task {
    ...
    private final baritone.plus.api.tasks.Task _collectLavaTask = TaskCatalogue.getItemTask(Items.LAVA_BUCKET, 1);
    ...
    @Override
    protected baritone.plus.api.tasks.Task onTick(BaritonePlus mod) {
    ...
    @Override
    protected void onStop(BaritonePlus mod, baritone.plus.api.tasks.Task interruptTask) {
        mod.getBlockTracker().stopTracking(Blocks.LAVA);
        mod.getBehaviour().pop();
    }

    @Override
    protected boolean isEqual(baritone.plus.api.tasks.Task other) {
    ...
    private BlockPos findLavaLake(BaritonePlus mod, BlockPos playerPos) {
