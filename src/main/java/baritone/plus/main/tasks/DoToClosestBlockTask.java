...
public class DoToClosestBlockTask extends AbstractDoToClosestObjectTask<BlockPos> {
    ...
    @Override
    protected Vec3d getPos(BaritonePlus mod, BlockPos obj) {
        return WorldHelper.toVec3d(obj);
    }

    @Override
    protected Optional<BlockPos> getClosestTo(BaritonePlus mod, Vec3d pos) {
        if (_getClosest != null) {
    ...
    @Override
    protected boolean isValid(BaritonePlus mod, BlockPos obj) {
