...
import baritone.plus.api.util.serialization.ItemDeserializer;
import baritone.plus.api.util.serialization.ItemSerializer;
...
public class MLGBucketTask extends Task {
    ...
    private static void moveLeftRight(BaritonePlus mod, int delta) {
        if (delta == 0) {
    ...
    private static void moveForwardBack(BaritonePlus mod, int delta) {
        if (delta == 0) {
    ...
    private Task onTickInternal(BaritonePlus mod, BlockPos oldMovingTorwards) {
    ...
    private Task placeMLGBucketTask(BaritonePlus mod, BlockPos toPlaceOn) {
    ...
    private void handleForwardVelocity(BaritonePlus mod, boolean newForwardTarget) {
    ...
    private Optional<BlockPos> getBlockWeWillLandOn(BaritonePlus mod) {
     ...
     */
    private void handleCancellingSidewaysVelocity(BaritonePlus mod) {
    ...
    private Optional<BlockPos> getBestConeClutchBlock(BaritonePlus mod, BlockPos oldClutchTarget) {
    ...
    private boolean hasClutchItem(BaritonePlus mod) {
    ...
    class ConeClutchContext {
        ...
        public ConeClutchContext(BaritonePlus mod) {
            hasClutchItem = hasClutchItem(mod);
        }

        public void checkBlock(BaritonePlus mod, BlockPos check) {
            // Already checked
