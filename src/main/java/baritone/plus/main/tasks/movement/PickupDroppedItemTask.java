...
import baritone.plus.main.tasks.resources.SatisfyMiningRequirementTask;
...
public class PickupDroppedItemTask extends AbstractDoToClosestObjectTask<ItemEntity> implements ITaskRequiresGrounded {
    ...
    public static boolean isIsGettingPickaxeFirst(BaritonePlus mod) {
    ...
    @Override
    protected Optional<ItemEntity> getClosestTo(BaritonePlus mod, Vec3d pos) {
    ...
    @Override
    protected boolean isValid(BaritonePlus mod, ItemEntity obj) {
