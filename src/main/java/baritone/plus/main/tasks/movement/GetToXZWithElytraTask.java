...
import baritone.plus.main.tasks.misc.RepairToolTask;
import baritone.plus.main.tasks.slot.ClickSlotTask;
...
public class GetToXZWithElytraTask extends Task {
    ...
    private int getGroundHeightWithRadius(BaritonePlus mod, int x, int z) {
        int topY = 0;
