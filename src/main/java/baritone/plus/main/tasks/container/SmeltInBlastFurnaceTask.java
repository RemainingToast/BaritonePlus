...
import baritone.plus.main.tasks.resources.CollectFuelTask;
...
import baritone.plus.api.util.slots.BlastFurnaceSlot;
...
public class SmeltInBlastFurnaceTask extends ResourceTask {
    ...
    static class DoSmeltInBlastFurnaceTask extends DoStuffInContainerTask {
        ...
        @Override
        protected boolean isContainerOpen(BaritonePlus mod) {
        ...
        private void tryUpdateOpenBlastFurnace(BaritonePlus mod) {
