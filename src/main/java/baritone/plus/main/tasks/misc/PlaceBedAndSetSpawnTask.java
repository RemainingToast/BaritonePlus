...
public class PlaceBedAndSetSpawnTask extends Task {
    ...
    private BlockPos locateBedRegion(BaritonePlus mod, BlockPos origin) {
    ...
    private boolean isGoodToPlaceInsideOrClear(BaritonePlus mod, BlockPos pos) {
    ...
    private boolean isGoodAsBorder(BaritonePlus mod, BlockPos pos) {
