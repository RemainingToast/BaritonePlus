...
import baritone.plus.main.tasks.entity.AbstractKillEntityTask;
...
public class KillEnderDragonTask extends Task {
    ...
    private static Task getPickupTaskIfAny(BaritonePlus mod, Item... itemsToPickup) {
    ...
    private BlockPos locateExitPortalTop(BaritonePlus mod) {
    ...
    private class PunkEnderDragonTask extends Task {
        ...
        private void hit(BaritonePlus mod) {
        ...
        private BlockPos getRandomWanderPos(BaritonePlus mod) {
