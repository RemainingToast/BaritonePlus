...
import baritone.plus.main.util.filestream.RoundtripMacroListFile;
...
public class RoundtripCommand extends PlusCommand {
    ...
    public RoundtripCommand() throws CommandException {
        ...
        super(new String[]{"roundtrip"}, "Tell bot to travel to a set of coordinates."/*,
    ...
    private void executeNextViaThread(final BaritonePlus mod) {
    ...
    private void executeNext(final BaritonePlus mod) throws CommandException {
    ...
    private void start(final BaritonePlus mod) {
