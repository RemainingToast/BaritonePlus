...
import baritone.plus.api.util.slots.*;
...
public class ItemStorageTracker extends Tracker {
    ...
    public ItemStorageTracker(BaritonePlus mod, TrackerManager manager, Consumer<ContainerSubTracker> containerTrackerConsumer) {
        super(manager);
