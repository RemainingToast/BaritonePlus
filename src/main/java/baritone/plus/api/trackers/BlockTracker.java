...
import baritone.plus.api.trackers.blacklisting.WorldLocateBlacklist;
...
public class BlockTracker extends Tracker {
    ...
    public BlockTracker(BaritonePlus mod, TrackerManager manager) {
        super(manager);
        _mod = mod;
...
//                    Debug.logWarning("BlockTracker: Not tracking block " + block + " right now.");
    ...
    static class PosCache {
        ...
        public void blacklistBlockUnreachable(BaritonePlus mod, BlockPos pos, int allowedFailures) {
        ...
        public Optional<BlockPos> getNearest(BaritonePlus mod, Vec3d position, Predicate<BlockPos> isValid, Block... blocks) {
            if (!anyFound(blocks)) {
         ...
         */
        public void smartPurge(BaritonePlus mod, Vec3d playerPos) {
