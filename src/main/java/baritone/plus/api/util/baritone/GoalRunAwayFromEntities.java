...
public abstract class GoalRunAwayFromEntities implements Goal {
    ...
    public GoalRunAwayFromEntities(BaritonePlus mod, double distance, boolean xzOnly, double penaltyFactor) {
        _mod = mod;
        _distance = distance;
        _xzOnly = xzOnly;
    ...
    protected abstract List<Entity> getEntities(BaritonePlus mod);
