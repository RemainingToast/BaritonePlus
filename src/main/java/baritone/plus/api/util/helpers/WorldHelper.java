...
import baritone.plus.launch.mixins.EntityAccessor;
...
public interface WorldHelper {
    ...
    static int getGroundHeight(BaritonePlus mod, int x, int z) {
    ...
    static BlockPos getADesertTemple(BaritonePlus mod) {
    ...
    static boolean isUnopenedChest(BaritonePlus mod, BlockPos pos) {
        return mod.getItemStorage().getContainerAtPosition(pos).isEmpty();
    }

    static int getGroundHeight(BaritonePlus mod, int x, int z, Block... groundBlocks) {
    ...
    static boolean canBreak(BaritonePlus mod, BlockPos pos) {
    ...
    static boolean isInNetherPortal(BaritonePlus mod) {
        if (mod.getPlayer() == null)
            return false;
        return ((EntityAccessor) mod.getPlayer()).isInNetherPortal();
    }

    static boolean dangerousToBreakIfRightAbove(BaritonePlus mod, BlockPos toBreak) {
    ...
    static boolean canPlace(BaritonePlus mod, BlockPos pos) {
        return !mod.getExtraBaritoneSettings().shouldAvoidPlacingAt(pos)
                && canReach(mod, pos);
    }

    static boolean canReach(BaritonePlus mod, BlockPos pos) {
    ...
    static boolean isAir(BaritonePlus mod, BlockPos pos) {
    ...
    static boolean isInteractableBlock(BaritonePlus mod, BlockPos pos) {
    ...
    static boolean isInsidePlayer(BaritonePlus mod, BlockPos pos) {
    ...
    static Iterable<BlockPos> scanRegion(BaritonePlus mod, BlockPos start, BlockPos end) {
        return () -> new Iterator<>() {
    ...
    static boolean isChest(BaritonePlus mod, BlockPos block) {
...
//        Debug.logMessage("canSleepOnServer (isSingleplayer || server == null): true");
    ...
    static int getHighestY(BaritonePlus mod) {
    ...
    static boolean isUnderground(BaritonePlus mod, int threshold) {
