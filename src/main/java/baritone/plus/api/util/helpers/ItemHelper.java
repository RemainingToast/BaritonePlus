...
public class ItemHelper {
    ...
    public static final Item[] TOOLS_AXES = new Item[]{Items.WOODEN_AXE, Items.STONE_AXE, Items.IRON_AXE, Items.GOLDEN_AXE, Items.DIAMOND_AXE, Items.NETHERITE_AXE};
    ...
    private static boolean isStackProtected(BaritonePlus mod, ItemStack stack) {
    ...
    public static boolean canThrowAwayStack(BaritonePlus mod, ItemStack stack) {
