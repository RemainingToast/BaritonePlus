...
import baritone.plus.launch.mixins.AbstractFurnaceScreenHandlerAccessor;
...
public class StorageHelper {
    ...
    public static MiningRequirement getCurrentMiningRequirement(BaritonePlus mod) {
    ...
    private static boolean h(BaritonePlus mod, boolean inventoryOnly, Item... items) {
        if (inventoryOnly) {
    ...
    private static boolean miningRequirementMetInner(BaritonePlus mod, boolean inventoryOnly, MiningRequirement requirement, BlockState mining) {
...
//            Debug.logError("Could not find a best tool for block " + mining.getBlock().getTranslationKey());
    ...
    public static boolean miningRequirementMet(BaritonePlus mod, MiningRequirement requirement) {
        return miningRequirementMetInner(mod, false, requirement, requirement.getBlockState());
    }

    public static boolean miningRequirementMetInventory(BaritonePlus mod, MiningRequirement requirement) {
        return miningRequirementMetInner(mod, true, requirement, requirement.getBlockState());
    }

    public static boolean miningRequirementMet(BaritonePlus mod, MiningRequirement requirement, BlockState toMine) {
        return miningRequirementMetInner(mod, false, requirement, toMine);
    }

    public static boolean miningRequirementMetInventory(BaritonePlus mod, MiningRequirement requirement, BlockState toMine) {
    ...
    public static Optional<Slot> getGarbageSlot(BaritonePlus mod) {
     ...
     */
    public static boolean itemTargetsMet(BaritonePlus mod, ItemTarget... targetsToMeet) {
     ...
     */
    public static boolean itemTargetsMetInventory(BaritonePlus mod, ItemTarget... targetsToMeet) {
     ...
     */
    public static boolean itemTargetsMetInventoryNoCursor(BaritonePlus mod, ItemTarget... targetsToMeet) {
    ...
    public static boolean isArmorEquipped(BaritonePlus mod, Item... any) {
        for (Item item : any) {
    ...
    public static int getBuildingMaterialCount(BaritonePlus mod) {
    ...
    public static boolean isArmorEquippedAll(BaritonePlus mod, Item... items) {
        return Arrays.stream(items).allMatch(item -> isArmorEquipped(mod, item));
    }

    public static boolean isEquipped(BaritonePlus mod, Item... items) {
        return ArrayUtils.contains(items, StorageHelper.getItemStackInSlot(PlayerSlot.getEquipSlot()).getItem());
    }

    public static int calculateInventoryFoodScore(BaritonePlus mod) {
        int result = 0;
    ...
    public static double calculateInventoryFuelCount(BaritonePlus mod) {
        double result = 0;
        if (!mod.getItemStorage().getItemStacksPlayerInventory(true).isEmpty()) {
            for (ItemStack stack : mod.getItemStorage().getItemStacksPlayerInventory(true)) {
    ...
    public static boolean hasRecipeMaterialsOrTarget(BaritonePlus mod, RecipeTarget... targets) {
    ...
    public static boolean hasCataloguedItem(BaritonePlus mod, String cataloguedName) {
     ...
     * are none.
     */
    public static Optional<Slot> getFilledInventorySlotInaccessibleToContainer(BaritonePlus mod, ItemTarget withItem) {
    ...
    public static boolean isItemInaccessibleToContainer(BaritonePlus mod, ItemTarget item) {
    ...
    public static boolean instantFillRecipeViaBook(BaritonePlus mod, CraftingRecipe recipe, Item output, boolean craftAll) {
